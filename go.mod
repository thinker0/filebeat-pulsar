...
require (
	github.com/apache/pulsar-client-go v0.8.1-0.20220506141544-1e37f2fc93f3
...
require (
	...
	github.com/Azure/azure-event-hubs-go/v3 v3.3.15 // indirect
	...
	github.com/hashicorp/nomad/api v0.0.0-20200303134319-e31695b5bbe6 // indirect
...
replace (
	...
	github.com/golang/glog => github.com/slok/noglog v0.2.1-0.20181001030204-470afb9f333a
)
